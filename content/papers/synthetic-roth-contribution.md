...
**Passman, Wong, & Dickson (2025)** — *A "BETR" Approach to Roth Conversions*, Vanguard (July 2025) — state: *"paying conversion taxes from a taxable account lets investors move some of their savings (the amount of the conversion taxes) from a taxable account to a Roth account."* Yet their math then nets those same dollars back out — the conversion tax never enters the Roth. The break-even rate is saved only by symmetric omission of the dollars from both sides of the comparison. The SRC framework places them explicitly in the Roth with present value $K$ at the portfolio rate (§4), additive to the rate-spread component rather than embedded in a BETR adjustment.
