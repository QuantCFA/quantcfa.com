...
A Roth conversion's value is conventionally framed as the present-value impact of converting Traditional dollars at today's tax rate, $t_C$, to avoid distributing later at the time-weighted $t_D$ (typically higher). The "spread arbitrage" is the converted amount times $(t_D - t_C)$, modulated by time, growth, Social Security, and inflation.
