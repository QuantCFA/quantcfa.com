...
A four-cent rounding residual. **The SRC's algebraic identity is empirically confirmed under RMD distributions**, despite varying per-year differentials from \$831 (year 2030) to \$2,596 (year 2049) for the owner plus a flat \$3,901 (years 2050–2059) for the beneficiary.
