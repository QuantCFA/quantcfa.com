...
Jill's advisor's assumed taxable multiple of 2 implies a 37.5% annual tax rate on investment returns (§6) — implausibly high for most investors. Framing it as a multiple obscures what an explicit drag rate would have made alarming.
