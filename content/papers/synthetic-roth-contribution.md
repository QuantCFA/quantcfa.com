...
**Passman, Wong, & Dickson (2025)** — *A "BETR" Approach to Roth Conversions*, Vanguard (July 2025) — compute a break-even future tax rate (BETR) for an Outside-funded Roth conversion. Their Jill case (35% current bracket, 24% future, \$100,000 conversion, 20-year horizon, \$35,000 conversion tax): the conversion-tax dollar is grown in a hypothetical taxable account (\$35K → \$70K) and subtracted from the Roth side as a "forgone after-tax value": \$300,000 (full Roth growth) − \$70,000 = \$230,000. The no-conversion case is \$300,000 traditional IRA growth at the future rate, with the \$35,000 that would have stayed in the bank omitted entirely. BETR = 23.3%; convert since 24% > 23.3%. The math works via symmetric omission but never places the \$35,000 inside the Roth wrapper — despite Vanguard's narrative that the conversion *"allows more dollars to be placed in a tax-advantaged account."* The SRC framework places the \$35,000 explicitly in the Roth with present value $K$ at the portfolio rate (§4) — additive to the rate-spread component, not embedded in a BETR adjustment.
