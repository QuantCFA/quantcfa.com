...
**Passman, Wong, & Dickson (2025)** — *A "BETR" Approach to Roth Conversions*, Vanguard (July 2025) — compute a break-even future tax rate (BETR) for an Outside-funded conversion. Jill case (35% current rate, 24% future, \$100,000 conversion, 20-year horizon, \$35,000 conversion tax): Conversion case: \$100K Roth triples to \$300K; the \$35K tax, had it stayed invested in a taxable account, would have doubled to \$70K, so the "forgone after-tax value" nets the Roth down to \$300K − \$70K = \$230K. No-conversion case: the \$100K traditional IRA triples to \$300K, then owes tax at the future rate. BETR is the rate that equates them: solving \$300K × (1 − BETR) = \$230K yields 23.3%. Since Jill's 24% future rate exceeds 23.3%, conversion wins. The math works via symmetric omission but never places the \$35,000 inside the Roth wrapper — despite Vanguard's narrative that the conversion *"allows more dollars to be placed in a tax-advantaged account."* The SRC framework places the \$35,000 explicitly in the Roth with present value $K$ at the portfolio rate (§4) — additive to the rate-spread component, not embedded in a BETR adjustment.
