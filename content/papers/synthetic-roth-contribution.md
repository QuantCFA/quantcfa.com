...
For Vanguard's $M = 3$, $M' = 2$, $n = 20$: $d = 37.5\%$ — implicitly assuming a substantially higher tax-inefficiency than this paper's $d = 5\%$ baseline (which corresponds to $M' \approx 2.74$ against $M = 3$). Vanguard's BETR and the SRC's drag-avoidance alpha are reparameterizations of the same underlying wrapper-drag wedge;
