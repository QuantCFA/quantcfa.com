...
**Passman, Wong, & Dickson (2025)** — *A "BETR" Approach to Roth Conversions*, Vanguard (July 2025) — come closest to recognizing the SRC when they observe that *"paying conversion taxes from a taxable account lets investors move some of their savings (the amount of the conversion taxes) from a taxable account to a Roth account."* Yet they omit conversion tax from the Roth side of the convert/no-convert analysis. To make the math work, they also omit counterfactual bank cash. Jill's case: at her 24% future rate, conversion gives \$230K vs no-conversion's \$228K — a \$2K drag-alpha. The BETR is the future rate at which the two would be equal: solving \$300K × (1 − BETR) = \$230K gives 23.3%. The alternative framing \$300K vs \$298K (Trad × (1−24%) + \$70K), retaining the forgone bank growth on both sides, yields the same BETR. The math is invariant; Vanguard's choice psychologically frames the tax as a cost rather than a migrated asset. The resulting BETR measures only the drag-alpha — the \$2K differential between sheltering the conversion tax inside the Roth wrapper versus exposing it to taxable-account drag. Our SRC framework restores what their quote alluded to, pricing the migrated tax explicitly at present value $K$ at the portfolio rate, additive to the drag-alpha rather than absorbed into a break-even rate adjustment.
