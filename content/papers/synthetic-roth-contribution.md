...
**3.9647 is a structural constant:** Different sized conversions — filling through the 10%, 12%, or 22% bracket (the \$123,850 case examined here) — each compute the same 3.9647 payout multiple. This is the empirical signature of the SRC framework's internal consistency. The payout multiple is a structural property of the distribution schedule and input assumptions.
