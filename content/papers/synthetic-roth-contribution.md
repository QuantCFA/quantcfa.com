...
**McQuarrie (2024)** — *Net Present Value Analysis of Roth Conversions*, Journal of Financial Planning 37(7/9): 76–90 — concludes from NPV calculations at the portfolio discount rate that "it is not all that helpful to pay the tax on conversion from outside funds." The conclusion rests on two methodological choices: (i) NPV discounted at the portfolio rate, and (ii) treatment of the year-0 conversion tax as a cost recouped by the discounted stream of future RMD-driven tax savings. In his 22% → 25% base case on \$100K, the discounted savings do not overtake the \$22,000 upfront tax until age 97; at life expectancy (age 90), the household remains \$7,000 short in PV. He concludes that *"the \$22,000 tax payment made in 2025 was, in all but name, a loan to the government."*

The underlying mathematical identity is the same one proved in §4: $\mathrm{PV}(\text{Outside} - \text{Inside}) = 0$ when the discount rate equals the portfolio return $r$. The interpretive divergence is substantive. McQuarrie reads this identity as a refutation of the practical importance of outside-payment. The SRC framework reads it as confirming that the outside-payment value equals the conversion tax in year-0 dollars (the contribution-equivalent), with economic significance arising through the tax-drag-differential channel of §6 — a channel McQuarrie's same-rate assumption ($r_{\text{Bank}} = r_{\text{Roth}} = 6\%$) eliminates by construction.

The after-tax wealth balance sheet, evaluated at the distribution-year rate $t_D = 25\%$, makes the structure visible at the moment of conversion:

| | Trad (pre-tax) | Roth (tax-free) | Bank (after-tax) | Total after-tax wealth |
|---|---|---|---|---|
| **Pre-conversion** | \$100K (\$75K after-tax) | \$0 | \$22K | **\$97K** |
| **Outside payment** | \$0 | \$100K | \$0 | **\$100K** |
| **Inside payment** | \$0 | \$78K | \$22K | **\$100K** |

Two effects appear. First, both paths produce identical **+\$3,000** gains in total after-tax wealth (\$97K → \$100K) — the rate-arbitrage Core, $(t_D - t_C) \cdot C$, which McQuarrie's NPV identifies. Second, the wrapper-composition difference: Outside places \$22,000 more in Roth and \$22,000 less in Bank than Inside, with identical \$100,000 after-tax totals. That wrapper-composition difference is the Synthetic Roth Contribution.

McQuarrie's analysis runs entirely off the \$100,000 Traditional shadow balance — his Table 1 RMD reductions and year-by-year tax savings all trace to that single number — and does not track the post-conversion Roth balance separately. The \$22,000 in the Roth under Outside payment is absent from his accounting. Consequently, there is no time-horizon break-even: the alpha components sum to a single PV at conversion, either positive or negative from year 0; time only unfolds the consequences. The "loan to the government" is the household's own \$22,000, sitting in the Roth from year 0, compounding tax-free.

The identity is derivable from McQuarrie's own data. His Table 1 column 8 — tax-at-22% on each year's RMD over the 27-year horizon — discounted at the 6% portfolio rate his paper uses for NPV, sums to ~\$22,000, equal to the upfront conversion tax. This is the matched-rate PV identity of §4: $\mathrm{PV}_r$ of the avoided-distribution-tax stream at the conversion rate equals $K$. McQuarrie published the column but computed only Col 7 − Col 8 (the \$3,000 Core), treating the \$22,000 as a one-sided cost.

McQuarrie's "NPV-to-This-Point" is a running partial sum of discounted cash flows, not the conversion's NPV — the single-scalar NPV is locked in at year 0 (+\$3,000 above) and does not "become" positive at age 97; what changes at age 97 is only the cumulative cash arrival. The framing's "recoupment horizon" also reflects a tautology: discounting tax-free Roth distributions at the same rate as their compounding necessarily produces PV = principal, making positive-return tax-free wrappers appear value-neutral by construction.
